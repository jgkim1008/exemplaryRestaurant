...
class DetailViewController: UIViewController {
    ...
    private lazy var titleLabel = UILabel.makeLabel(font: .title1, text: viewModel.title, color: .black)
    private lazy var typeLabel = UILabel.makeLabel(font: .caption1, text: viewModel.type, color: .black)
    private var locationImageView = UIImageView(image: UIImage(systemName: "map.circle"))
    private lazy var locationLabel = UILabel.makeLabel(font: .body, text: viewModel.locationName, color: .black)
    private lazy var foodMenuLabel = UILabel.makeLabel(font: .body, text: viewModel.foodMenu, color: .black)
